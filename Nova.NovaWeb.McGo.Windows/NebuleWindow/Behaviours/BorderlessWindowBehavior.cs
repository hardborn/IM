...
namespace Nova.NovaWeb.McGo.Windows.Behaviours
{
    public class BorderlessWindowBehavior : Behavior<Window>
    {
        ...
        protected override void OnAttached()
        {
            ...
            if (AssociatedObject is NebulaWindow)
            {
                var window = ((NebulaWindow)AssociatedObject);
        ...
        private void HandleMaximize()
        {
            ...
            if (monitor != IntPtr.Zero)
            {
                var monitorInfo = new MONITORINFO();
                UnsafeNativeMethods.GetMonitorInfo(monitor, monitorInfo);
                bool ignoreTaskBar = AssociatedObject as NebulaWindow != null && ((NebulaWindow)this.AssociatedObject).IgnoreTaskbarOnMaximize;
        ...
        private IntPtr HwndHook(IntPtr hWnd, int message, IntPtr wParam, IntPtr lParam, ref bool handled)
        {
            ...
            switch (message)
            {
                ...
                case Constants.WM_INITMENU:
                    var window = AssociatedObject as NebulaWindow;
