...
namespace Nova.NovaWeb.Windows.Utilities
{
    public class ExcelHelper
    {
       ...
       /// <param name="excelName"></param>
        public bool SaveToExcel(string excelName,DataTable dataTable)
        {
            try
            {
                if (dataTable != null)
        ...
        private void SaveExcel(string excelName)
        {
            ...
            _book.SaveAs(excelName, Excel.XlFileFormat.xlExcel7, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Excel.XlSaveAsAccessMode.xlNoChange, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
            _excelApp.Quit();
